...
public class MakeNonUsers {
	...
	public static void run(ApplicationContext appContext, ProfileRepo profileRepo) throws ParseException {
		...
		/// Create Posts
		Post post1 = new Post(formatter.parse("01/02/2019 12:49:31 AM"), "", 
				"iterate global e-services", cpaolettoa);
		postRepo.insert(post1);
		
		Post post2 = new Post(formatter.parse("01/03/2019 08:17:09 AM"), "", 
				"engage strategic paradigms", cpaolettoa);
		postRepo.insert(post2);
		
		Post post3 = new Post(formatter.parse("01/03/2019 11:37:45 PM"), "", 
				"repurpose viral convergence", etassellg);
		postRepo.insert(post3);
		
		Post post4 = new Post(formatter.parse("01/04/2019 01:36:16 PM"), "", 
				"recontextualize synergistic interfaces", ehedden9);
		postRepo.insert(post4);
		
		Post post5 = new Post(formatter.parse("01/06/2019 03:28:07 AM"), "", 
		...
		//// Create comments
		Comment comment1 = new Comment(formatter.parse("01/03/2019 12:02:06 PM"),"In congue.",
				blynasn, post1
		);
		Comment comment2 = new Comment(formatter.parse("01/04/2019 10:48:15 AM"),
				"Curabitur convallis.",jdantesiam, post2
		);
		Comment comment3 = new Comment(formatter.parse("01/04/2019 03:33:24 PM"),
				"Mauris lacinia sapien quis libero. Nullam sit amet turpis elementum ligula vehicula consequat.",
				blynasn, post3
		);
        Comment comment4 = new Comment(formatter.parse("01/05/2019 06:52:54 AM"),
        		"Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; "
        		+ "Donec pharetra, magna vestibulum aliquet ultrices",bbucknero, post4
        );
		Comment comment5 = new Comment(formatter.parse("01/05/2019 09:53:54 AM"),"Aenean auctor gravida sem. "
